...
| [ProjFlow](../model_zoo/projflow.md) | HumanML3D SMPL-22 joints | Root path · waypoint · arbitrary Cartesian joint masks | Native API and exact-constraint verification |
...
| ProjFlow | HumanML3D SMPL-22 joints | Sparse pelvis trajectory | 1 release case | < 0.0001 mm | Not benchmark-ranked | API verification only |
