...
| PRISM (epoch 18) | 0.1933 | 0.3106 | 0.3908 | 0.0680 | 53.5178 | 0.0645 | 62.3776 |
...
PRISM uses the current `checkpoint-epoch_18` result with a fixed 360-frame
canvas for every model call; the complete 1,295-episode run contains no legacy
365-frame calls.
...
or terminal-joint twists from positions alone. Each complete episode is
