...
| **Dance-to-Music · AIST++** | Complete | [UniMuMo + GT](hf_space_dance_to_music/dance_to_music_results.json) | [86 motion/audio cases · 2/2 rows](https://zeyuling-dance-to-music-aistpp-leaderboard.static.hf.space/cases/index.html) | [Results](https://huggingface.co/spaces/ZeyuLing/dance-to-music-aistpp-leaderboard) · [Dataset](../datasets/README.md#aistpp) · [Source](hf_space_dance_to_music) |
