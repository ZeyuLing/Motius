...
| **Text-to-Motion · Unitree G1** | Direct G1-native generation on the fixed robotic test split, normalized to `g1_38` for TMR-G1 evaluation. | [↗ Results](https://huggingface.co/spaces/ZeyuLing/t2m-unitree-g1-leaderboard) · [🧾 Source](hf_space_t2m_unitree_g1) · [📋 Protocol](t2m_unitree_g1.md) · [📐 Evaluator](../evaluator_zoo/g1_tmr.md) |
