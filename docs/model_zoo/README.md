...
| --- | --- | --- |
| [Text-to-Motion](../leaderboards/README.md#text-to-motion) | Text → motion · [HumanML3D](https://huggingface.co/spaces/ZeyuLing/t2m-humanml3d-leaderboard) · [Unitree G1](https://huggingface.co/spaces/ZeyuLing/t2m-unitree-g1-leaderboard) | [ARDY](ardy.md) · [CondMDI](condmdi.md) · [DART](dart.md) · [FlowMDM](flowmdm.md) · [HY-Motion T2M](hymotion_t2m.md) · [KIMODO](kimodo.md) · [MaskControl](maskcontrol.md) · [MDM](mdm.md) · [MLD](mld.md) · [MoGenTS](mogents.md) · [MoMask](momask.md) · [MotionCLR](motionclr.md) · [MotionGPT](motiongpt.md) · [MotionLCM](motionlcm.md) · [MotionMillion](motionmillion.md) · [MotionStreamer](motionstreamer.md) · [OmniControl](omnicontrol.md) · [PRISM](prism.md) · [T2M-GPT](t2mgpt.md) · [TM2D](tm2d.md) · [UniMuMo](unimumo.md) · [ViMoGen](vimogen.md) |
...
| [Monocular Motion Capture](https://huggingface.co/spaces/ZeyuLing/monocular-motion-capture-leaderboard) | Monocular RGB video → camera/world body motion | [GEM-SMPL](gem_smpl.md) · [GEM-X](gem_x.md) · [GVHMR](gvhmr.md) · [HYMotion-V2M](hymotion_v2m.md) · [PromptHMR-Video](prompthmr.md) |
...
| [GEM-SMPL](gem_smpl.md) | [Monocular Motion Capture](https://huggingface.co/spaces/ZeyuLing/monocular-motion-capture-leaderboard) | `SMPL-24` | [📦 Official weights](https://huggingface.co/nvidia/GEM-X/blob/main/gem_smpl.ckpt) |
| [GEM-X](gem_x.md) | [Monocular Motion Capture](https://huggingface.co/spaces/ZeyuLing/monocular-motion-capture-leaderboard) | `SOMA-77` | [📦 Official weights](https://huggingface.co/nvidia/GEM-X) |
| [GVHMR](gvhmr.md) | [Monocular Motion Capture](https://huggingface.co/spaces/ZeyuLing/monocular-motion-capture-leaderboard) | `SMPL-24` | [↗ Official weights](https://github.com/zju3dv/GVHMR/blob/main/docs/INSTALL.md) |
...
| [HYMotion-V2M](hymotion_v2m.md) | [Monocular Motion Capture](https://huggingface.co/spaces/ZeyuLing/monocular-motion-capture-leaderboard) | `SMPL-H-52` | [↗ Official weights](https://github.com/Tencent-Hunyuan/HY-Motion-1.0) |
...
| [PromptHMR-Video](prompthmr.md) | [Monocular Motion Capture](https://huggingface.co/spaces/ZeyuLing/monocular-motion-capture-leaderboard) | `SMPL-X` | [↗ Official weights](https://github.com/yufu-wang/PromptHMR#installation) |
