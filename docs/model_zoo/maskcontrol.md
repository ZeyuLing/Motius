...
| Item | Value |
| ---- | ----- |
| Tasks | Text-to-Motion, Temporal Motion Completion, Kinematic Motion Control, Part-Level Motion Control |
| Experimental task API | Sequential Text-to-Motion |
...
```python
prediction = pipe.infer_temporal_motion_completion(
...
unconditional = pipe.infer_temporal_motion_completion(
    None,
    [reference_hml263],
    mode="prefix",
    seed=42,
...
```python
edited = pipe.infer_part_level_motion_control(
    [
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| temporal_start_1f | 4,012 | 0.5627 | 0.7340 | 0.8143 | 0.0491 | 32.3544 | 55.4882 | 3.5610 | 0.1475 |
| temporal_pre20 | 4,012 | 0.5905 | 0.7618 | 0.8300 | 0.0489 | 31.7072 | 55.3250 | 3.7536 | 0.1478 |
| temporal_pre20_uncond | 4,012 | 0.3327 | 0.4695 | 0.5497 | 0.0798 | 40.4863 | 54.6372 | 3.7328 | 0.1158 |
| temporal_both_1f | 4,012 | 0.5873 | 0.7535 | 0.8300 | 0.0402 | 31.2923 | 55.3465 | 4.3254 | 0.1571 |
| temporal_mid80 | 4,012 | 0.6218 | 0.7823 | 0.8538 | 0.0410 | 30.9639 | 55.1793 | 4.4834 | 0.1546 |
| temporal_mid80_uncond | 4,012 | 0.3847 | 0.5413 | 0.6345 | 0.0936 | 38.8152 | 53.9980 | 4.4934 | 0.1246 |
| temporal_adaptive_keyframes | 4,012 | 0.6372 | 0.8007 | 0.8692 | 0.0426 | 30.4901 | 55.0010 | 4.7904 | 0.1724 |
| temporal_adaptive_keyframes_uncond | 4,012 | 0.6015 | 0.7742 | 0.8488 | 0.0430 | 31.6811 | 54.7080 | 4.6801 | 0.1491 |
...
| Motius Joint-Position Evaluator | 4,034 | 0.3733 | 0.5623 | 0.6615 | 0.5457 | 44.1737 | 50.2912 |
