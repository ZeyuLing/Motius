...
<table>
  ...
  <tr>
    ...
    <td align="center"><sub>Krump</sub></td>
    <td align="center"><sub>Waacking</sub></td>
  </tr>
</table>

[Open the audio-synchronized 40-case GT/Bailando comparison](https://zeyuling-music-to-dance-aistpp-leaderboard.static.hf.space/cases/index.html?method=bailando).
...
| Clock | Rate |
| --- | --- |
| Training motion | 60 fps motion; 7.5 fps music features |
| Public preview | 30 fps, duration-preserving 60→30 fps motion resampling with audio synchronization |
...
result = pipe.infer_music_to_dance("music.wav")
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Bailando | 40 | 28.1072 | 9.7006 | 0.3138 | 7.7272 | 6.3092 | 0.2268 |
