...
- [Audio-synchronized AIST++ all-case M2D comparison](https://zeyuling-music-to-dance-aistpp-leaderboard.static.hf.space/cases/index.html?method=tm2d)
...
| Public preview | 30 fps, duration-preserving 60→30 fps motion resampling with synchronized audio for Music-to-Dance |
...
`Pipeline.from_pretrained` therefore needs no second checkpoint download.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| TM2D | 40 | 43.4186 | 20.4244 | 0.2623 | 3.7742 | 3.1335 | 0.1903 |
