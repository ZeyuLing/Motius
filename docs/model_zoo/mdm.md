...
| ---------------- | ---------- | ------------ |
| `001840` | someone executes a roundhouse kick with their left foot. | <img src="../../assets/model_zoo/mdm/mdm_humanml3d_001840_smpl_mesh_512_30fps.gif" width="220" alt="MDM HumanML3D 001840 SMPL demo"> |
| `004545` | a person jumping while raising both hands and moving apart legs. | <img src="../../assets/model_zoo/mdm/mdm_humanml3d_004545_smpl_mesh_512_30fps.gif" width="220" alt="MDM HumanML3D 004545 SMPL demo"> |
| `006944` | a person moves their right hand left, right, up, and down. | <img src="../../assets/model_zoo/mdm/mdm_humanml3d_006944_smpl_mesh_512_30fps.gif" width="220" alt="MDM HumanML3D 006944 SMPL demo"> |
