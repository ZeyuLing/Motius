...
def test_unimumo_exposes_canonical_dance_task_aliases():
    assert (
        UniMuMoPipeline.infer_music_to_dance
        is UniMuMoPipeline.infer_music_to_motion
    )
    assert (
        UniMuMoPipeline.infer_dance_to_music
        is UniMuMoPipeline.infer_motion_to_music
    )
