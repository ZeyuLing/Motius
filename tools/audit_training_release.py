...
RELEASE_PATHS = (
    ...
    ROOT / "configs/motioncanvas/README.md",
    ROOT / "configs/motion_tracking/beyondmimic_g1_lafan1.yaml",
    ...
    ROOT / "motius/trainers/motioncanvas/trainer.py",
    ROOT / "motius/trainers/motioncanvas/sparse_rollout_join_trainer.py",
    ROOT / "motius/trainers/beyondmimic/train.py",
    ROOT / "motius/trainers/beyondmimic/prepare_motion.py",
    ROOT / "motius/trainers/beyondmimic/export_policy.py",
    ROOT / "docs/training/README.md",
    ROOT / "docs/training/prism_tmr_hymotion_t2m.md",
    ROOT / "docs/model_zoo/hymotion_t2m.md",
    ROOT / "docs/model_zoo/prism.md",
    ROOT / "docs/model_zoo/motioncanvas.md",
    ROOT / "docs/model_zoo/beyondmimic.md",
    ROOT / "docs/evaluator_zoo/motius_joint_position.md",
    ROOT / "tools/train.py",
    ROOT / "tools/download_beyondmimic_assets.py",
)
