...
def main():
    ...
    # The base runtime sets a shared placeholder;
    ...
    default_work_dirs = {'outputs/training/default'}
    if not args.work_dir and (not cfg_work_dir or cfg_work_dir in default_work_dirs):
