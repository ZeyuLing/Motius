...
CASES = {
    "001840": (
        "hands in fighting position while the left foot kicks aggressively "
        "up and over."
    ),
    "004545": (
        "a person jumps with legs open while clapping with hands over head "
        "simultaneously."
    ),
    "006944": (
        "the person who does arms straight out and then it’s doing something "
        "with their right hand in front of their face."
    ),
