...
| `robots/` | Robot descriptions required by physical-controller trainers | Download from the source-pinned upstream archive |
...
export MOTIUS_BEYONDMIMIC_ASSET_ROOT="$PWD/checkpoints/robots"
```
