...
class UniMuMoPipeline(BasePipeline):
    ...
    infer_music_to_dance = infer_music_to_motion
    ...
    infer_dance_to_music = infer_motion_to_music
    ...
    def __call__(self, *args, task: str = "text-to-music-motion", **kwargs):
        methods = {
            ...
            "music-to-dance": self.infer_music_to_dance,
            "dance-to-music": self.infer_dance_to_music,
