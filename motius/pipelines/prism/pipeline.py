...
class PRISMPipeline(BasePipeline):
    ...
    infer_temporal_motion_completion = temporal_condition
    infer_tp2m = temporal_condition
    infer_sequential_text_to_motion = sequential_generation
    infer_sequential_t2m = sequential_generation
