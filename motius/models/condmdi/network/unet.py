...
class MDM_UNET(nn.Module):
    ...
    def __init__(self,
        ...
        # CondMDI's released checkpoint operates on HML263 features. SMPL
        # conversion is handled by Motius, so the upstream Rotation2xyz module
        # and its licensed body-model files are not runtime dependencies.
        self.rot2xyz = None
    ...
    def load_and_freeze_clip(self, clip_version):
        if clip is None:
            raise RuntimeError(
                "CondMDI requires OpenAI CLIP. Install the CondMDI extra or "
