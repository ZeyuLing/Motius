...
from motius.models.motionbricks.network.motion_backbone.demo.controllers import WASD_controller, random_controller
from motius.models.motionbricks.network.exp_setup.experiment import test
...
class navigation_demo(object):
    ...
    def _initialize_inference_modles(self):
        ...
        from motius.models.motionbricks.network.motion_backbone.demo.full_agent import full_navigation_agent
