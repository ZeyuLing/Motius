...
from motius.models.motionbricks.network.motionlib.core.motion_reps.tools.motion_features import (
    compute_vel_angle,
    compute_vel_xyz,
)
from motius.models.motionbricks.network.motionlib.core.skeletons import SkeletonBase
from motius.models.motionbricks.network.motionlib.core.utils.rotations import (
    angle_to_Y_rotation_matrix,
    quat_apply,
    quat_conjugate,
)
from motius.models.motionbricks.network.motionlib.core.utils.stats import Stats
...
class LocalRootLocalBody(SeparatedRootLocalBody):
    ...
    def change_first_heading(
        ...
        if not self.removed_heading:
            ...
            from motius.models.motionbricks.network.motionlib.core.motion_reps.tools.heading import calc_heading_from_joints_pos
