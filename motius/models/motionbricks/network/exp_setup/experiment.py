...
from motius.models.motionbricks.network.helper.pl_util import load_motion_rep
...
def test(args: argparse.Namespace = None):
    ...
    for model_name in ['pose', 'root']:
        ...
        from motius.models.motionbricks.network.motionlib.train.utils import get_rank, setup_train_logging
