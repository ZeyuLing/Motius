...
_INTERGEN_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
class MotionNormalizer():
    def __init__(self):
        mean = np.load(os.path.join(_INTERGEN_DIR, "data", "global_mean.npy"))
        std = np.load(os.path.join(_INTERGEN_DIR, "data", "global_std.npy"))
...
class MotionNormalizerTorch():
    def __init__(self, mean_path=None, std_path=None):
        if mean_path is None or std_path is None:
            mean_path = os.path.join(_INTERGEN_DIR, "data", "global_mean.npy")
            std_path = os.path.join(_INTERGEN_DIR, "data", "global_std.npy")
