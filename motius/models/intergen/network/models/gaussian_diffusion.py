...
from .losses import InterLoss, GeometricLoss
...
class MotionDiffusion(GaussianDiffusion):
    ...
    def __init__(self, use_timesteps, motion_rep, **kwargs):
        mean_path = kwargs.pop("mean_path", None)
        ...
        self.normalizer = MotionNormalizerTorch(mean_path=mean_path, std_path=std_path)
