...
# todo - configable
SMPL_MODEL_DIR = os.environ.get("MOTIUS_SMPL_MODEL_DIR", "data/smpl_models/")
GMM_MODEL_DIR = os.environ.get("MOTIUS_GMM_MODEL_DIR", SMPL_MODEL_DIR)
SMPL_MEAN_FILE = os.environ.get(
    "MOTIUS_SMPL_MEAN_FILE",
    os.path.join(SMPL_MODEL_DIR, "neutral_smpl_mean_params.h5"),
)
# for collsion
Part_Seg_DIR = os.environ.get(
    "MOTIUS_SMPL_PART_SEG_FILE",
    os.path.join(SMPL_MODEL_DIR, "smplx_parts_segm.pkl"),
)
