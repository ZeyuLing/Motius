...
class CMDM(torch.nn.Module):
    def __init__(self, modeltype, njoints, nfeats, num_actions, translation, pose_rep, glob, glob_rot,
        ...
        # Upstream uses this only for visualization and training losses. Motius
        # decodes HumanML3D outputs through its representation API instead.
        self.rot2xyz = None
        # --- MDM ---
    ...
    def cmdm_forward(self, x, timesteps, y=None, weight=1.0):
        ...
        seq_mask = y.get('hint_frame_mask')
        if seq_mask is None:
