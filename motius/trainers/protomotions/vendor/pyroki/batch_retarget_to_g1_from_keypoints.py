...
N_retarget = 15
N_AUX = 3
PYROKI_MAX_ITERATIONS = int(os.environ.get("PYROKI_MAX_ITERATIONS", "800"))
...
def main():
    ...
    parser.add_argument(
        ...
        help="Maximum JAXLS solver iterations. Lower values are useful for online smoke tests.",
    )
...
def solve_retargeting(
    ...
    solution = (
        ...
        .solve(
            ...
            termination=jaxls.TerminationConfig(max_iterations=PYROKI_MAX_ITERATIONS),
        )
    )
