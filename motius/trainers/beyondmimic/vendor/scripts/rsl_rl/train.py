...
motion_source.add_argument("--motion_file", type=str, help="A local official-format BeyondMimic motion NPZ.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # Motius supports a local file without changing the official registry path.
    ...
    if args_cli.motion_file is not None:
        ...
        if ":" not in registry_name:  # append :latest when no alias is specified
