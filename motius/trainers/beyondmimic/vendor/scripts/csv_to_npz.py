...
output.add_argument("--output_name", type=str, help="The WandB motion artifact name.")
output.add_argument("--output_file", type=str, help="Write the converted NPZ locally.")
