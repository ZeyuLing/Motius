...
class LocalFlatTerrainImporter(TerrainImporter):
    """Spawn the flat ground locally without an NVIDIA Nucleus USD."""
    ...
    def import_ground_plane(
        ...
        if prim_path in self.terrain_prim_paths:
            raise ValueError(f"A terrain already exists at path: {prim_path}")
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        class_type=LocalFlatTerrainImporter,
